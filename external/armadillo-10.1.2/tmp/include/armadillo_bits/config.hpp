...
#define ARMA_USE_HDF5_ALT
  ...
  #define ARMA_HDF5_INCLUDE_DIR /u/thchem/newc6131/anaconda3/include/
#endif
...
#define ARMA_AUX_LIBS /opt/intel/compilers_and_libraries_2019.1.144/linux/mkl/lib/intel64/libmkl_rt.so;/u/thchem/newc6131/anaconda3/lib/libhdf5.so;/usr/lib64/librt.so;/usr/lib64/libpthread.so;/u/thchem/newc6131/anaconda3/lib/libz.so;/usr/lib64/libdl.so;/usr/lib64/libm.so
#define ARMA_AUX_INCDIRS /u/thchem/newc6131/anaconda3/include
