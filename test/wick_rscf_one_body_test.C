...
int test_ref_ref(const char *testcase, unsigned thresh)
{
    ...
    oss << "wick_rscf_one_body_test::test_ref_ref(" << testcase << ", " << thresh << ")";
    ...
    arma::mat hcore; 
    if(!hcore.load(fname_hcore, arma::raw_ascii)) return 1;
...
int test_ref_single(const char *testcase, unsigned thresh)
{
    // Report who we are
    std::ostringstream oss; 
    oss << "wick_rscf_one_body_test::test_ref_single(" << testcase << ", " << thresh << ")";
    std::cout << oss.str() << std::endl;
...
int test_single_single(const char *testcase, unsigned thresh)
{
    // Report who we are
    std::ostringstream oss; 
    oss << "wick_rscf_one_body_test::test_single_single(" << testcase << ", " << thresh << ")";
    std::cout << oss.str() << std::endl;
...
int test_single_double(const char *testcase, unsigned thresh)
{
    // Report who we are
    std::ostringstream oss; 
    oss << "wick_rscf_one_body_test::test_single_double(" << testcase << ", " << thresh << ")";
    std::cout << oss.str() << std::endl;
