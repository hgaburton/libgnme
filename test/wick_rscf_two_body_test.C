...
int test_ref_ref(const char *testcase, unsigned thresh)
{
    ...
    oss << "wick_rscf_two_body_test::test_ref_ref(" << testcase << ", " << thresh << ")";
    ...
    slat.evaluate(Cx.cols(xocca), Cx.cols(xoccb), Cw.cols(wocca), Cw.cols(woccb), sslat, fslat);
    ...
    {
        std::cout << "  Wick two-body = " << std::fixed << std::setw(thresh+10) 
                  << std::setprecision(thresh+1) << fwick << std::endl
                  << "Slater two-body = " << std::fixed << std::setw(thresh+10)
...
int test_ref_single(const char *testcase, unsigned thresh)
{
    // Report who we are
    std::ostringstream oss; 
    oss << "wick_rscf_two_body_test::test_ref_single(" << testcase << ", " << thresh << ")";
    std::cout << oss.str() << std::endl;
    ...
    for(size_t a=nocca; a<nmo; a++)
    {
        ...
        slat.evaluate(Cx.cols(wocca), Cx.cols(woccb), Cw.cols(xocca), Cw.cols(xoccb), sslat, fslat);
...
int test_single_single(const char *testcase, unsigned thresh)
{
    // Report who we are
    std::ostringstream oss; 
    oss << "wick_rscf_two_body_test::test_single_single(" << testcase << ", " << thresh << ")";
    std::cout << oss.str() << std::endl;
...
int test_single_double(const char *testcase, unsigned thresh)
{
    // Report who we are
    std::ostringstream oss; 
    oss << "wick_rscf_two_body_test::test_single_double(" << testcase << ", " << thresh << ")";
    std::cout << oss.str() << std::endl;
...
int main () {
    ...
    test_ref_ref("h2o_6-31g",6)       | 
    test_ref_single("h2o_6-31g",6)    | 
    test_single_single("h2o_6-31g",6) | 
    test_single_double("h2o_6-31g",6) |
    0;
}
